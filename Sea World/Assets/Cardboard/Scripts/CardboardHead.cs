...
public class CardboardHead : MonoBehaviour {
  ...
  private void UpdateHead() {
    ...
    // Changes: added if statement to handle null reference which is caused by cardboard trying to access a null AR Camera which happens in cardboard scene only
    if(SceneManager.GetActiveScene().name != "Cardboard_Scene")
    {
